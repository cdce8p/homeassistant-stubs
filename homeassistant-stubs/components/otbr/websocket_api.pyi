...
@websocket_api.websocket_command({'type': 'otbr/info'})
...
@websocket_api.websocket_command({'type': 'otbr/create_network', INCOMPLETE: str})
@websocket_api.require_admin
@websocket_api.async_response
@async_get_otbr_data
...
@websocket_api.websocket_command({'type': 'otbr/set_network', INCOMPLETE: str, INCOMPLETE: str})
@websocket_api.require_admin
@websocket_api.async_response
@async_get_otbr_data
async def websocket_set_network(hass: HomeAssistant, connection: websocket_api.ActiveConnection, msg: dict, data: OTBRData) -> None: ...
@websocket_api.websocket_command({'type': 'otbr/set_channel', INCOMPLETE: str, INCOMPLETE: int})
@websocket_api.require_admin
@websocket_api.async_response
@async_get_otbr_data
