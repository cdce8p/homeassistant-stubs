...
@websocket_api.websocket_command({INCOMPLETE: 'mqtt/device/debug_info', INCOMPLETE: str})
@callback
def websocket_mqtt_info(hass: HomeAssistant, connection: websocket_api.ActiveConnection, msg: dict[str, Any]) -> None: ...
@websocket_api.websocket_command({INCOMPLETE: 'mqtt/subscribe', INCOMPLETE: valid_subscribe_topic, INCOMPLETE: valid_qos_schema})
