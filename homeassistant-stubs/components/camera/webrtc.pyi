...
@websocket_api.websocket_command({INCOMPLETE: 'camera/webrtc/offer', INCOMPLETE: cv.entity_id, INCOMPLETE: str})
...
@websocket_api.websocket_command({INCOMPLETE: 'camera/webrtc/get_client_config', INCOMPLETE: cv.entity_id})
@websocket_api.async_response
...
@websocket_api.websocket_command({INCOMPLETE: 'camera/webrtc/candidate', INCOMPLETE: cv.entity_id, INCOMPLETE: str, INCOMPLETE: _parse_webrtc_candidate_init})
@websocket_api.async_response
