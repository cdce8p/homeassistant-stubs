...
@websocket_api.websocket_command({INCOMPLETE: 'history/history_during_period', INCOMPLETE: str, INCOMPLETE: str, INCOMPLETE: [str], INCOMPLETE: bool, INCOMPLETE: bool, INCOMPLETE: bool, INCOMPLETE: bool})
...
@websocket_api.websocket_command({INCOMPLETE: 'history/stream', INCOMPLETE: str, INCOMPLETE: str, INCOMPLETE: [str], INCOMPLETE: bool, INCOMPLETE: bool, INCOMPLETE: bool, INCOMPLETE: bool})
@websocket_api.async_response
