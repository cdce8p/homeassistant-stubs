...
@callback
@websocket_api.websocket_command({INCOMPLETE: 'sensor/device_class_convertible_units', INCOMPLETE: str})
def ws_device_class_units(hass: HomeAssistant, connection: websocket_api.ActiveConnection, msg: dict[str, Any]) -> None: ...
@callback
@websocket_api.websocket_command({INCOMPLETE: 'sensor/numeric_device_classes'})
