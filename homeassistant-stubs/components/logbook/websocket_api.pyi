...
@websocket_api.websocket_command({INCOMPLETE: 'logbook/event_stream', INCOMPLETE: str, INCOMPLETE: str, INCOMPLETE: [str], INCOMPLETE: [str]})
...
@websocket_api.websocket_command({INCOMPLETE: 'logbook/get_events', INCOMPLETE: str, INCOMPLETE: str, INCOMPLETE: [str], INCOMPLETE: [str], INCOMPLETE: str})
@websocket_api.async_response
