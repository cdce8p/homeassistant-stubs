...
@websocket_api.websocket_command({INCOMPLETE: 'frontend/set_user_data', INCOMPLETE: str, INCOMPLETE: vol.Any(bool, str, int, float, dict, list, None)})
...
@websocket_api.websocket_command({INCOMPLETE: 'frontend/get_user_data', INCOMPLETE: str})
@websocket_api.async_response
@with_store
