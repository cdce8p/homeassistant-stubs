...
@websocket_api.require_admin
@websocket_api.websocket_command({INCOMPLETE: 'config/auth/create', INCOMPLETE: str, INCOMPLETE: [str], INCOMPLETE: bool})
@websocket_api.async_response
async def websocket_create(hass: HomeAssistant, connection: websocket_api.ActiveConnection, msg: dict[str, Any]) -> None: ...
@websocket_api.require_admin
@websocket_api.websocket_command({INCOMPLETE: 'config/auth/update', INCOMPLETE: str, INCOMPLETE: str, INCOMPLETE: bool, INCOMPLETE: [str], INCOMPLETE: bool})
@websocket_api.async_response
